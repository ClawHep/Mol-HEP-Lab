...
fn artifact_satisfied(name: &str, available: &[String]) -> bool {
    ...
    let aliases: &[(&str, &[&str])] = &[
        ...
        ("screened_papers", &["candidates.md", "candidates.jsonl", "screened_papers.jsonl"]),
        ("exclusion_reasons", &["candidates.md", "candidates.jsonl", "exclusion_reasons.json"]),
        ("knowledge_cards", &["knowledge_cards.md", "knowledge_cards.json"]),
        ("citation_map", &["citation_map.md", "citation_map.json"]),
        ...
        ("codebase_context", &["codebase_context.md", "codebase_context.json"]),
        ("relevant_files", &["relevant_files.md", "relevant_files.json"]),
        ...
        ("raw_results", &["runs/", "run_report.md"]),
        ("run_logs", &["runs/", "run_report.md"]),
        ("refined_results", &["refinement_log.md", "refinement_log.json", "experiment_final/"]),
        ...
        ("blinding_config", &["blinding_config.md", "blinding_config.json", "blinding_status.json"]),
        ("systematics_table", &["systematics_table.md", "systematics_table.json", "systematics.json"]),
