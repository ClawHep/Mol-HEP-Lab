const zh: Record<string, string> = {
  ...
  'project.mode.help': '🔬 Lab·讨论：多方向并行调研，Phase 2 综合 (2.4) 后跨方向讨论达成共识，生成统一假设。\n\n🔬 Lab·独立：多方向并行调研，各方向独立生成假设，速度更快但无跨方向共识。\n\n📄 论文复现：单 Agent 全流程复现目标论文的方法与实验。',
  ...
  'layer.execution.name': 'P3 · 执行',
  'layer.execution.desc': '实验设计、代码开发与执行',
  ...
  'repo.exp_design.desc': '实验方案、代码库上下文',
  ...
  'repo.papers.desc': '论文大纲、初稿、评审、修订稿、终稿',
  ...
  'discussion.dialog_body': '【讨论模式 (推荐)】\n多个方向的 Agent 各自完成 Phase 2 步骤 2.1-2.4 (调研→综合与假设) 后暂停，等全部就绪后触发跨方向讨论，产出共识综述，最终选出最佳方向进入下游实验。\n✅ 综合多视角，假设质量更高\n✅ 避免重复研究\n\n【独立模式】\n每个方向的 Agent 独立跑完 Phase 2，互不通信。各自生成假设后分别进入下游实验。\n⚡ 更快 (无需等待同步)\n⚠️ 方向可能重叠，没有共识整合\n\n注: 无论哪种模式，知识仓库和实验结果仓库始终在 Agent 间共享。',
  'discussion.hint_on': '2.4 综合后跨方向讨论 → 共识假设',
